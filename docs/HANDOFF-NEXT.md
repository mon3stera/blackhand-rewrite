...
**待用户验证 boot2-shw65**（提交 `81747f8`，侦探类线索枚举加入影武者：覆盖共享键 `F2239D82`→「侦探、监视者、密探/先锋、纵火者、影武者」（1,15/1,16/1,30/2,10/3,5/3,31/5,10 七角色共用；sc2pack merge_strings 支持覆盖原键）。**用户确认影武者本体已无问题；DT 语音 DarkTemplar_What 已认可**）**）：
