...
**待用户验证 boot2-shw59**（提交 `35f5419`，影武者夜间击杀补全出场流程：台词 SHWQUOTE「我从阴影中现身」→ Zeratul 音效 → 全场红字 SHWHEAR 破风声 → 目标私息 SHWNIGHT；新增 gf_BHNotify（虚拟补位目标的私密消息改发主机，solo 可见；SHWNIGHT×2/SHWSURV/被救治提示 4 处走路由）。注：51592af 又只提交了 strings，代码在 35f5419；shw58 没有代码改动请勿使用）**）：
